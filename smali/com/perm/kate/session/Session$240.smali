...
.method constructor <init>(Lcom/perm/kate/session/Session;Lcom/perm/kate/session/Callback;Landroid/app/Activity;JJ)V
    ...
    iput-wide p4, p0, Lcom/perm/kate/session/Session$240;->val$group_id:J

    iput-wide p6, p0, Lcom/perm/kate/session/Session$240;->val$link_id:J
...
.method public run()V
    ...
    iget-wide v1, p0, Lcom/perm/kate/session/Session$240;->val$group_id:J

    iget-wide v3, p0, Lcom/perm/kate/session/Session$240;->val$link_id:J

    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/perm/kate/api/Api;->deleteGroupLink(JJ)Ljava/lang/Integer;
