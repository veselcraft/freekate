...
.method public success(Lcom/perm/kate/api/WallMessage;)V
    ...
    iput v2, v1, Lcom/perm/kate/api/WallMessage;->like_count:I

    const/4 v2, 0x1

    .line 535
    iput-boolean v2, v1, Lcom/perm/kate/api/WallMessage;->user_like:Z

    .line 536
    iput-boolean v2, v1, Lcom/perm/kate/api/WallMessage;->user_reposted:Z

    .line 537
    iget p1, p1, Lcom/perm/kate/api/WallMessage;->reposts_count:I

    iput p1, v1, Lcom/perm/kate/api/WallMessage;->reposts_count:I

    .line 538
    new-instance p1, Lcom/perm/kate/WallMessageActivity$12$1;

    invoke-direct {p1, p0}, Lcom/perm/kate/WallMessageActivity$12$1;-><init>(Lcom/perm/kate/WallMessageActivity$12;)V
